...
window.PERM = {
  ...
  moverStatus:      r => ['admin','gestor','atendente','mecanico','equipe'].includes(r),
  adicionarLog:     r => ['admin','gestor','atendente','mecanico','equipe'].includes(r),
  verFinanceiro:    r => ['admin','gestor'].includes(r),
